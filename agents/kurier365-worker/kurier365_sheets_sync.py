#!/usr/bin/env python3
"""agents/kurier365-worker/kurier365_sheets_sync.py

Publisher: czyta zakładkę 'Propozycje Kurier365' z Google Sheets,
...
TAB_NAME    = "Propozycje Kurier365"
SERVICE_ACC = os.environ.get("GOOGLE_SA_FILE", "/home/ubuntu/media-dispatch/config/service_account.json")
PORTAL_ID   = os.environ.get("KURIER365_PORTAL_ID", "")  # UUID portalu kurier365.pl w PressAI
PORTAL_NAME = "Kurier365"
...
def main():
    print("Start: kurier365_sheets_sync.py")
